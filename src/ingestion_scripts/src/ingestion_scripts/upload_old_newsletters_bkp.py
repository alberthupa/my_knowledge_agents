...
def process_newsletters_for_date(
    ...
    for msg_summary in messages:
        ...
        custom_props = {
            ...
            "subject": subject,
            "author": sender,  # Renamed to avoid conflict if 'from' is a keyword
            "chunk_date": message_date_iso,  # Date from email header
...
if __name__ == "__main__":
    ...
    # Define date range: January 1, 2025 to today
    ...
    if not all([gmail_service_instance, container_client_instance, embeddings_client]):
        ...
        while current_date <= end_date:
            ...
            # Sleep between dates (except after the last date)
